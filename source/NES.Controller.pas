...
begin
  ...
  case Code of
    ...
    18: Result := SkAlt;
    19: Result := SkPause;
    20: Result := SkCapsLock;
    27: Result := SkEsc;
    32: Result := SkSpace;
    33: Result := SkPageUp;
    34: Result := SkPageDown;
    35: Result := SkEnd;
    36: Result := SkHome;
    37: Result := SkLeft;
    38: Result := SkUp;
    ...
    45: Result := SkIns;
    46: Result := SkDelete;
    106: Result := SkNumpadMultiply;
    107: Result := SkNumpadPlus;
    109: Result := SkNumpadMinus;
    110: Result := SkNumpadDot;
    111: Result := SkNumpadDivide;
    144: Result := SkNumLock;
    186: Result := SkSemiColon;
    187: Result := SkEqual;
    188: Result := SkComma;
    189: Result := SkMinus;
    190: Result := SkDot;
    191: Result := SkSlash;
    192: Result := SkGrave;
    219: Result := SkLeftBracket;
    220: Result := SkBackslash;
    221: Result := SkRightBracket;
    222: Result := SkApostrophe;
  end;
end;
